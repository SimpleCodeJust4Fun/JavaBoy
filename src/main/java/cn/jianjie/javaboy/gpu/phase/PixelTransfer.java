...
import cn.jianjie.javaboy.gpu.*;
import cn.jianjie.javaboy.gpu.*;

import static cn.jianjie.javaboy.gpu.GpuRegister.*;
...
public class PixelTransfer implements GpuPhase {
    ...
    public PixelTransfer(AddressSpace videoRam0, AddressSpace videoRam1, AddressSpace oemRam, Display display, Lcdc lcdc, GpuRegisterValues r, boolean gbc, ColorPalette bgPalette, ColorPalette oamPalette, OamSearch.SpritePosition[] sprites) {
        this.r = r;
        this.lcdc = lcdc;
        this.gbc = gbc;
        if (gbc) {
