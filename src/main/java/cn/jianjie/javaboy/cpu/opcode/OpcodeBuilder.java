package cn.jianjie.javaboy.cpu.opcode;

import cn.jianjie.javaboy.cpu.*;
import cn.jianjie.javaboy.cpu.op.Op;
import cn.jianjie.javaboy.gpu.SpriteBug;
import cn.jianjie.javaboy.AddressSpace;
import cn.jianjie.javaboy.cpu.*;
import cn.jianjie.javaboy.cpu.op.Argument;
import cn.jianjie.javaboy.cpu.op.DataType;

import java.util.*;

import static cn.jianjie.javaboy.cpu.BitUtils.toWord;
